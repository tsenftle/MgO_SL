...
%% Inputs
file = '../Step_2/adsorbate/MgO_adsorbate_DL.txt'; % Specify the descriptor set
Dimension = 1:8;                                   % Determine the dimension

%% load dataset generated in data generation from step 1 directory
load('../Step_1/adsorbate/data_set_adsorbate.mat')
...
%%  Use the descriptors selected by adsorbate-modified MgO
Y = Data_A_train;
D_p = Data_A_p_train;
head_p = head_A_all;
...
%%  Use the descriptors selected by adsorbate-modified MgO for test set
Y_test = Data_A_test;
D_p_test = Data_A_p_test;
